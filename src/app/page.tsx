      ...
      <div className="max-w-4xl mx-auto text-center px-8">
          ...
          <div className="flex items-center justify-center space-x-6 mb-8">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="text-left">
                ...
                <p className="text-lg text-gray-600 mt-2">Advanced Customer Analytics Platform</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
            ...
            <p className="text-gray-600">Monitor customer interactions and sales performance across all locations.</p>
          </div>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-3">Customer Intelligence</h3>
            <p className="text-gray-600">AI-powered insights into customer sentiment and behavior patterns.</p>
          </div>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-3">Live Monitoring</h3>
            <p className="text-gray-600">Track store performance and identify optimization opportunities.</p>
          </div>
        </div>
